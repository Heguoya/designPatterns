 ...
 * （没有达到 lazy loading 效果），而这种方式是 Singleton 类被装载了，instance 不一定被初始化。
 ...
 * @Date 2018/9/2
 */
public class RegisteredSingleton implements Serializable {
    private static final long serialVersionUID = 8858242829179293657L;
